...
<body>
  <header>
    <h1 style="font-size:30px; margin-top:10px; margin-bottom:10px; background-color:#009FFF">フォーム > 入力</h1>
  </header>
  <section>
    <form action="issue50_confirm.php" method="POST">
      <fieldset>
        <legend>フォーム</legend>
        <label for="name" style="background-color:#FF3000"> 名前：</label>
        ...
        <br>
        <label for="male" style="background-color:#FF3000">性別：</label>
        ...
        <br>  
        <label for="postcode" style="background-color:#FF3000">郵便番号：</label>
        ...
        <br>
        <label for="prefecture" style="background-color:#FF3000">都道府県：</label>
        ...
        <br>        
        <label for="mailaddress" style="background-color:#FF3000">メールアドレス：</label>
        ...
        <br>
        <label for="hobby" style="background-color:#FF3000"> 趣味：</label>
        ...
        <br>
        <label for="opinion" style="background-color:#FF3000">ご意見：</label>
